...
export const PERMISSIONS = {
  // 1. OVERVIEW
  OVERVIEW_ACTION: ['SUPER_DEV', 'AKTIVATOR'], // Solved/Cancel action

  // 2. DATA CLIENT
  CLIENT_ADD: ['SUPER_DEV', 'NOC', 'AKTIVATOR', 'ADMIN'],
  CLIENT_EDIT_DELETE: ['SUPER_DEV', 'ADMIN'],

  // 3. WORK ORDERS
  WO_CREATE: ['SUPER_DEV', 'AKTIVATOR'], // NOC & ADMIN cannot create
  WO_VIEW_DETAILS: ['SUPER_DEV', 'NOC', 'AKTIVATOR', 'ADMIN', 'CS'],

  // 4. TRACKER
  TRACKER_INPUT: ['SUPER_DEV', 'AKTIVATOR'], // NOC & ADMIN cannot input

  // 5. VLAN MASTER
  VLAN_EDIT_DELETE: ['SUPER_DEV', 'NOC', 'AKTIVATOR'], // ADMIN & CS view only

  // 6. TOOLS & UTILITIES
  TOOLS_IP_CALC: ['SUPER_DEV', 'NOC', 'AKTIVATOR', 'ADMIN', 'CS'],
  TOOLS_REPORT_GEN: ['SUPER_DEV', 'NOC', 'AKTIVATOR', 'ADMIN', 'CS'],
  TOOLS_WO_DISTRIBUTOR_VIEW: ['SUPER_DEV', 'AKTIVATOR', 'ADMIN'], // NOC cannot access
  TOOLS_WO_DISTRIBUTOR_ACTION: ['SUPER_DEV', 'ADMIN'], // Aktivator can only view/get/download
